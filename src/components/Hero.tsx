...
const heroSlides = [
  {
    ...
    image: "https://images.unsplash.com/photo-1684596423225-d9eda48e888e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjBidWlsZGluZyUyMHNpdGV8ZW58MXx8fHwxNzY0NjEyMTU1fDA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1630259970029-7b1e1160243e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjBidWlsZGluZyUyMHNpdGV8ZW58MXx8fHwxNzY0NzM3MTM4fDA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1695067438561-75492f7b6a9c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBhcmNoaXRlY3R1cmUlMjBidWlsZGluZ3xlbnwxfHx8fDE3NjQ3MTk1Mjh8MA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1622120573004-c70648f2352e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcmNoaXRlY3R1cmFsJTIwZGVzaWduJTIwbW9kZXJufGVufDF8fHx8MTc2NDc3NTk0OHww&ixlib=rb-4.1.0&q=80&w=1080"
  }
];
      ...
      <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex gap-2 z-20">
        {heroSlides.map((_, index) => (
          <motion.button
            ...
            className={`h-1.5 rounded-full transition-all duration-300 ${index === currentSlide ? "w-12 bg-red-500" : "w-8 bg-white/50"
              }`}
