 ...
 * ---------------------
 * 1. Copy an existing project object from the projectsData array
 * 2. Update all fields with the new project information
 * 3. Ensure the 'category' field matches an existing category ID
 * 4. Provide high-quality images from Unsplash or your own sources
 * 5. The project will automatically appear in the appropriate category
 * 
 * Adding a New Category:
 * ----------------------
 * 1. Add a new category object to the 'categories' array at the bottom
 * 2. Use a unique 'id' in lowercase-with-hyphens format
 * 3. Provide a descriptive title and description
 * 4. Create projects with this category ID
 * 5. The category will automatically appear on the homepage
 * 
 * Field Descriptions:
 * -------------------
 * @property {string} id - Unique identifier (lowercase-with-hyphens)
 * @property {string} title - Display name of the project
 * @property {string} location - Project location (City, District)
 * @property {string} type - Project type (Residential, Commercial, etc.)
 * @property {string} category - Must match a category ID
 * @property {string} image - Main project image URL
 * @property {string} description - Short description (1 line)
 * @property {string} fullDescription - Detailed project description
 * @property {string} year - Year of completion
 * @property {string} client - Client organization name
 * @property {string} area - Total area (e.g., "45,000 sq ft")
 * @property {string} duration - Project duration (e.g., "24 months")
 * @property {string[]} gallery - Array of image URLs for gallery
 * @property {string[]} features - Array of key features/amenities
 * @property {string} challenges - Main challenges faced
 * @property {string} solution - Solutions implemented
 * 
 * @module ProjectData
 */
...
export const projectsData: Project[] = [
  ...
  {
    id: "luxury-residential-complex-gulshan",
    title: "Luxury Residential Complex",
    location: "Gulshan, Dhaka",
    type: "Residential",
    category: "luxury-residential-complex",
    image: "https://images.unsplash.com/photo-1672508013582-035e75fb76ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXNpZGVudGlhbCUyMGJ1aWxkaW5nJTIwZXh0ZXJpb3J8ZW58MXx8fHwxNzY0NjY4MDkyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    duration: "24 months",
    gallery: [
      "https://images.unsplash.com/photo-1672508013582-035e75fb76ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXNpZGVudGlhbCUyMGJ1aWxkaW5nJTIwZXh0ZXJpb3J8ZW58MXx8fHwxNzY0NjY4MDkyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  // Commercial Office Tower Projects
  {
    ...
    image: "https://images.unsplash.com/photo-1632398793634-e3cd63fc9e84?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21tZXJjaWFsJTIwYnVpbGRpbmclMjBtb2Rlcm58ZW58MXx8fHwxNzY0NjgxNjAzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    duration: "28 months",
    gallery: [
      "https://images.unsplash.com/photo-1632398793634-e3cd63fc9e84?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21tZXJjaWFsJTIwYnVpbGRpbmclMjBtb2Rlcm58ZW58MXx8fHwxNzY0NjgxNjAzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  // Infrastructure Development Projects
  {
    ...
    duration: "18 months",
    gallery: [
      "https://images.unsplash.com/photo-1638207849658-e57be0cdc208?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaXZpbCUyMGVuZ2luZWVyaW5nJTIwY29uc3RydWN0aW9ufGVufDF8fHx8MTc2NDY4NzIyN3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      ...
      "https://images.unsplash.com/photo-1590759668628-05b0fc34276d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmZyYXN0cnVjdHVyZSUyMGRldmVsb3BtZW50fGVufDF8fHx8MTc2NDY5MTc0OHww&ixlib=rb-4.1.0&q=80&w=1080",
    ],
    features: [
  ...
  // Architectural Marvel Projects
  {
    ...
    image: "https://images.unsplash.com/photo-1721244653757-b76cc4679dfb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidWlsZGluZyUyMGRlc2lnbiUyMGJsdWVwcmludHxlbnwxfHx8fDE3NjQ2ODk3NDB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    duration: "30 months",
    gallery: [
      "https://images.unsplash.com/photo-1721244653757-b76cc4679dfb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidWlsZGluZyUyMGRlc2lnbiUyMGJsdWVwcmludHxlbnwxfHx8fDE3NjQ2ODk3NDB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
